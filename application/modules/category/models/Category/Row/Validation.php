<?php
class Category_Model_Category_Row_Validation extends Core_Model_Table_Row_Validation_Abstract
{
    ...
    {    
        ...
        {  
            $this->setError($key, 'Please enter valid category name.');
            return false;
        }
        return true;
    }
    ...
    {
        if(!$this->getRowClassObject()->category_id)
        {
            if(!$this->_getDateModel()->isDate($this->getRowClassObject()->{$key}))
            {
                return false;
