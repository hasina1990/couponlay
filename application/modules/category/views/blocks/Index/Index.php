<?php
class Category_View_Block_Index_Index extends User_View_Block_Widget_Grid
{
   ...
   protected $_codeCount = null;
    ...
    {
        $websites = Ccc::getModel("user/session")->getSession("categoryWiseWebsites");
    ...
    public function getCategoryWiseWebsites()
    {
        return Ccc::getModel("user/session")->getSession("categoryWiseWebsites");
    }
    ...
    public function getCouponViewUrl($id)
    {
        ...
        return $this->baseUrl(Ccc::getModel("core/url_rewrite")->getUrlKey($this->getCategory()->category_id, Core_Model_Url_Rewrite::ENTITY_CATEGORY))."/page/".$page."?cpn_id=".$id;
    }
}
