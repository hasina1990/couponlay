<?php
/**
*	Ccc_Admin_Model_Search
**/
class Admin_Model_Search extends Core_Model_Abstract
{
	/**
	...
	**/
    ...
    {	
		...
		if(Ccc::getModel('admin/session')->has('search'))
		{
			$search = Ccc::getModel('admin/session')->get('search');
		}
		else
		{
			$search = array();
	...
	**/
	public function setSearch()
	{
		...
		if($front->getRequest()->isPost())
		{
            ...
            Ccc::getModel('admin/session')->setSession('search', $search);
		}
		else
		{
			$data = array();
			...
			Ccc::getModel('admin/session')->set('search', $search);
		}
