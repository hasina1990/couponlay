<?php
class Admin_Menu_FooterController extends Ccc_Controller_Action_Admin
{
    public function indexAction()
    {
        try
        {
            $this->_setTitle('Manage Footer Links')->_setActiveTab('system');        
            $this->getResponse()->appendBody(Ccc::getBlock("admin/menu_footer_index")->toHtml());
            ...
            $response = array(
                ...
                'content'=>array(
                    array(
                        ...
                        'html'=>Ccc::getBlock("admin/menu_footer_index")->toHtml(),
                    )
                ),
                'message'=>''
            );
        ...
        { 
            $response = array(
                ...
                'content'=>array(
                    array(
                        'element'=>'grid-list',
                        'html'=>Ccc::getBlock("admin/menu_footer_grid")->toHtml(),
                    )
                ),
                'message'=>''
            );
        ...
        { 
            $response = array(
                ...
                'content'=>array(
                    array(
                        'element'=>'main-container',
                        'html'=>Ccc::getBlock("admin/menu_footer_create")->toHtml(),
                    )
                ),
                'message'=>''
            );
        ...
        try
        {
            ...
            $response = array(
                ...
                'action'=>array(
                    array(
                        'element'=>'main-container',
                        'url'=>$this->view->baseUrl('admin/menu_footer/index-json')
                    )),
                'redirectURL' => $this->view->baseUrl('admin/menu_footer/index-json')  
            );
        }
