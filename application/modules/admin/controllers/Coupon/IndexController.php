<?php
class Admin_Coupon_IndexController extends Ccc_Controller_Action_Admin
{
    public function indexAction()
    {
        try
        {
            $this->_setTitle('Manage Coupons')->_setActiveTab('coupon');        
            $this->getResponse()->appendBody(Ccc::getBlock("admin/coupon_index_index")->toHtml());
            ...
            $response = array(
                ...
                'content'=>array(
                    array(
                        ...
                        'html'=>Ccc::getBlock("admin/coupon_index_index")->toHtml(),
                    )
                ),
                'message'=>''
            );
        ...
        { 
            $response = array(
                ...
                'content'=>array(
                    array(
                        'element'=>'grid-list',
                        'html'=>Ccc::getBlock("admin/coupon_index_grid")->toHtml(),
                    )
                ),
                'message'=>''
            );
        ...
        { 
            $response = array(
                ...
                'content'=>array(
                    array(
                        'element'=>'main-container',
                        'html'=>Ccc::getBlock("admin/coupon_index_create")->toHtml(),
                    )
                ),
                'message'=>''
            );
        ...
        try
        {
            ...
            $response = array(
                ...
                'action'=>array(
                    array(
                        'element'=>'main-container',
                        'url'=>$this->view->baseUrl('admin/coupon_index/index-json')
                    )),
            );
        }
