<?php
class Admin_View_Block_Dashboard_Populardeals extends Admin_View_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('dashboard/populardeals.phtml'); 
    }
    ...
    protected function _prepareQuery()
    {
        ...
        $select = $couponModel->select()
                                ...
                                ->where("C.type = ?", Coupon_Model_Coupon::COUPON_TYPE_DEAL)
