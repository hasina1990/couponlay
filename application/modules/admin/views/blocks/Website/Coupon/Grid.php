<?php
class Admin_View_Block_Website_Coupon_Grid extends Admin_View_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setTemplate('website/coupon/grid.phtml');
    }
    ...
    {
        return $this->url(array('module'=>'admin','controller'=>'website_coupon','action'=>'reset','page'=>1),null,true);
    }
