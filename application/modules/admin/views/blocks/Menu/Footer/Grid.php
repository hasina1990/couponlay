<?php
class Admin_View_Block_Menu_Footer_Grid extends Admin_View_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setTemplate('menu/footer/grid.phtml');
    }
    ...
    protected function _setFilter($select)
    {
        ...
        if((int)Ccc::getHelper('admin/search')->search()->is_quicklink)
        {
            $select->where("M.is_quicklink = ?", (int)Ccc::getHelper('admin/search')->search()->is_quicklink);
        }
    ...
    public function getQuickLinkOptions()
    {
        return array(
            Core_Model_Menu::IS_QUICKLINK => Core_Model_Menu::IS_QUICKLINK_TEXT,
            Core_Model_Menu::IS_ABOUT_US => Core_Model_Menu::IS_ABOUT_US_TEXT
        );
    }
    
    public function getSectionText($id)
    {
           if($id == Core_Model_Menu::IS_QUICKLINK)
           {
               return Core_Model_Menu::IS_QUICKLINK_TEXT;
           }
           
           return Core_Model_Menu::IS_ABOUT_US_TEXT;
    }
    
    public function getResetUrl()
    {
        return $this->url(array('module'=>'admin','controller'=>'menu_footer','action'=>'reset','page'=>1),null,true);
    }
