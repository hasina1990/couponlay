<?php
class User_View_Block_Subscription_Index extends User_View_Block_Widget_Grid
{   
	public function __construct()                     
	{
        parent::__construct();
		$this->setTemplate('subscription/index.phtml');
	}
    ...
    public function getUnsubscibeUrl($website_id = null)
    {
        return null;
    }
