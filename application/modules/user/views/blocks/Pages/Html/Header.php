...
class User_View_Block_Pages_Html_Header extends Core_View_Block_Abstract
{
    ...
    {
        return $this->baseUrl("user/search/index");
    ...
    public function getCategoryTagWebsitePage()
    {
        if($this->getRequestObject()->getRequest()->getParam("website_id", 0))
        {
            $website = Ccc::getModel("user/session")->getSession("website", null);
        ...
        elseif($this->getRequestObject()->getRequest()->getParam("category_id", 0))
        {
        ...
        elseif($this->getRequestObject()->getRequest()->getParam("tag_id", 0))
        {
